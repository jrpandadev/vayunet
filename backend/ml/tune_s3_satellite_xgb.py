...
DATA_FILE = (
    ...
    / "processed"
    / "fusion"
    / "delhi_forecasting_satellite.csv"
)
...
RESULTS_CSV = RESULTS_DIR / "s3_tuning_results.csv"
BEST_PARAMS_JSON = RESULTS_DIR / "s3_best_params.json"
...
def main():
    ...
    print("\n" + "=" * 72)
    print("S3 SATELLITE XGBOOST TUNING")
    print("=" * 72)
