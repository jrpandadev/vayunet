      ...
      <div className="z-10 w-full max-w-md p-8 bg-gray-800/80 backdrop-blur-xl border border-gray-700/50 rounded-2xl shadow-2xl">
        ...
        <div className="mt-6 text-center">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 px-4 bg-white hover:bg-gray-100 text-gray-900 font-medium rounded-lg shadow transition-all flex items-center justify-center gap-2 disabled:opacity-50"
          >
